...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android  {str(rr(4,12))}; CPH2089 Build/RKQ1.{str(rr(111111,210000))}.190711.020; wv)) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/ {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/342.0.0.37.119;]"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; CPH2089 Build/RKQ1.{str(rr(111111,210000))}.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/ {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/312.0.0.45.117;]"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; CPH2089 Build/RKQ1.{str(rr(111111,210000))}.231003.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36  [FB_IAB/FB4A;FBAV/327.0.0.33.120;]"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; CPH2089 Build/RKQ1.{str(rr(111111,210000))}.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/348.0.0.39.118;]"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; CPH2089 Build/RKQ1.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/307.0.0.40.111;]"
...
"content-type": "multipart/form-data; boundary=----WebKitFormBoundarygtd6MENbhO8PRnrs", 
"x-fb-lsd": "AVrn2d3sFlw",
...
"referer": "https://m.facebook.com/login.php?skip_api_login=1&api_key=1239138353201716&kid_directed_site=0&app_id=1239138353201716&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv8.0%2Fdialog%2Foauth%3Fresponse_type%3Dcode%252Cgranted_scopes%26client_id%3D1239138353201716%26redirect_uri%3Dhttps%253A%252F%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D6d7ef8ec-1532-47ba-97ec-672832dc552c%26tp%3Dunspecified&cancel_url=%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr",
"accept-encoding": "gzip, deflate, br", 
