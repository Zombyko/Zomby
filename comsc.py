...
def setting():
	...
	if hu in ['1','01']:
		...
		exit()
	urut = []
	urut.append(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Login Site [bold green]m.facebook.com[bold white] [/]',width=42,title=f"[bold green]Validate",style=f"bold white"))
