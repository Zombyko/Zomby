...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android 6.0.1{str(rr(4,12))}; Nexus 7 Build/MOB30X).{str(rr(111111,210000))}. AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android 6.0.1{str(rr(4,12))}; Nexus 7 Build/MOB30X).{str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5672.53{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; U; Android 4.4.2; en-US {str(rr(4,12))}; ASUS_Z007 Build/KVT49L).{str(rr(111111,210000))}. AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 UCBrowser/10.5.2.582 U3/0.8.0{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/534.30"
    u4 = f"Mozilla/5.0 (Linux; U; Android 5.0; en-US {str(rr(4,12))}; ASUS_Z00AD Build/LRX21V) {str(rr(111111,210000))} AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 UCBrowser/10.6.2.599 U3/0.8.0 {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/534.30"
    u5 = f"Mozilla/5.0 (Linux; Android 10 {str(rr(4,12))}; K){str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
...
for x in range(10):
	...
	uak=f'Mozilla/5.0 (Linux; Android 10 {a}; K {b}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0{c}.0.{d}.{e} Mobile Safari/537.36'
def uaku():
	try:
