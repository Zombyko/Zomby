...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6832 Build/TP1A.str(rr(111111,210000))}.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/459.1.0.42.84;]"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6851 Build/UP1A.str(rr(111111,210000))}.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/464.0.0.60.90;]"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6526 Build/TP1A.str(rr(111111,210000))}.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6526 Build/TP1A.str(rr(111111,210000))}.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; Infinix X6850 Build/UP1A.str(rr(111111,210000))}.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))}  Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/464.0.0.60.90;]"
