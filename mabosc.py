...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android 6.0.1 {str(rr(4,12))}; SAMSUNG SM-G532MT) {str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/17.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android 4.4.4 {str(rr(4,12))}; SAMSUNG SM-J110H Build/KTU84P) {str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android 6.0.1 {str(rr(4,12))}; SAMSUNG SM-J500G Build/MMB29M) {str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android 10 {str(rr(4,12))}; K) {str(rr(111111,210000))} AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/24.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
